...
#[ApiResource(
    normalizationContext: [
        ...
        'openapi_definition_name' => 'Definition'
    ],
    ...
    collectionOperations: [
        ...
        'count' => [
            ...
            'filters' => [],
            'openapi_context' => [
                'summary' => 'Récupère le nombre total d\'articles existants',
                'parameters' => [
                    [
                        'in' => 'query',
                        'name' => 'online',
    ...
    itemOperations: [
        ...
        'publish' => [
            ...
            'openapi_context' => [
                'summary' => 'Permet de publier un article en ligne',
                'requestBody' => [
                    'content' => [
                        'application/json' => [
                            'schema' => []
...
class Post
{
    ...
    #[
        Groups(['read:collection']),
        ApiProperty(openapiContext: ['type' => 'boolean', 'description' => 'Statut de publication'])
    ]
